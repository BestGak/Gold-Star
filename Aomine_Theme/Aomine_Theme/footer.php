...
<footer>
        <div class="container">
            ...
            <?= is_front_page() ? 
                '<img src="'. get_stylesheet_directory_uri(  ) .'/assets/images/logo.svg" alt="Footer Logo">' :
                 '<a href="'. get_home_url() .'"><img src="'. get_stylesheet_directory_uri(  ) .'/assets/images/logo.svg" alt="Footer Logo"></a>' ?>
    ...
    <!-- <script src="<?= get_stylesheet_directory_uri() ?>/assets/js/jquery.js"></script> -->
